/**
 * \file NMR_RTCResult \brief  A class that stores one docking model
 * with NMR_RTC related scores
 *
 *
...
#ifndef IMP_NM_R_RTC_RESULT_H
#define IMP_NM_R_RTC_RESULT_H
...
public:
  NMR_RTCResult(int number, float score, bool filtered, int diff_num,
    ...
    diff_num_(diff_num), transformation_(transformation) {}
