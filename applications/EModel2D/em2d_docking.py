...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(description="Functions related to docking with HEX")
    parser.add_argument("fn_receptor",
                      default=False,
                     help="Receptor PDB file")
    parser.add_argument("fn_ligand",
                      default=False,
