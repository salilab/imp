...
class Tests(IMP.test.TestCase):
    ...
    def test_get_set(self):
        ...
        ssr = IMP.atom.SecondaryStructureResidue.setup_particle(
            p, 0.5, 0.25, 0.25)
    ...
    def test_coarsen(self):
        ...
        for i in range(3):
            ...
            av_w[nmax] += 1.0 / 3.0
            ps.append(p)
        coarse_ssr = IMP.atom.setup_coarse_secondary_structure_residue(
            ps, m, False)
        ...
        coarse_ssr_w = IMP.atom.setup_coarse_secondary_structure_residue(
            ps, m, True)
    ...
    def test_match_score(self):
        ...
        self.assertAlmostEqual(
            IMP.atom.get_secondary_structure_match_score(ssr1, ssr2),
            rmsd, delta=1e-6)
