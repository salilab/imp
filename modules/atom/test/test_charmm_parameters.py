...
class CHARMMParametersTests(IMP.test.TestCase):
    ...
    def test_bond_parameters(self):
        ...
        self.assertInTolerance(bonds[0].mean, 0.00, 1e-5)
        ...
        for types in [('CPB', 'CPA', 'NPH', 'CPA'),
            ...
            self.assertInTolerance(bond.mean, 0.0000, 1e-5)
        # Check wildcards
