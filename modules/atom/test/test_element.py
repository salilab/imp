...
class Tests(IMP.test.TestCase):
    ...
    def test_element_assignment(self):
        ...
        self.assertEqual(
            IMP.atom.Atom(ps[0].get_particle()).get_element(),
            IMP.atom.P)
        self.assertEqual(
            IMP.atom.Atom(ps[1].get_particle()).get_element(),
            IMP.atom.O)
        self.assertEqual(
            IMP.atom.Atom(ps[2].get_particle()).get_element(),
            IMP.atom.O)
        self.assertEqual(
            IMP.atom.Atom(ps[3].get_particle()).get_element(),
            IMP.atom.Ca)
        self.assertEqual(
            IMP.atom.Atom(ps[4].get_particle()).get_element(),
            IMP.atom.Mg)
        self.assertEqual(
            IMP.atom.Atom(ps[5].get_particle()).get_element(),
            IMP.atom.N)
        self.assertEqual(
            IMP.atom.Atom(ps[6].get_particle()).get_element(),
            IMP.atom.C)
        self.assertEqual(
            IMP.atom.Atom(ps[7].get_particle()).get_element(),
            IMP.atom.Cl)
        self.assertEqual(
            IMP.atom.Atom(ps[8].get_particle()).get_element(),
            IMP.atom.N)
        self.assertEqual(
            IMP.atom.Atom(ps[9].get_particle()).get_element(),
            IMP.atom.C)
        self.assertEqual(
            IMP.atom.Atom(ps[10].get_particle()).get_element(),
            IMP.atom.Ir)
        self.assertEqual(
            IMP.atom.Atom(ps[11].get_particle()).get_element(),
            IMP.atom.Pt)
        self.assertEqual(
