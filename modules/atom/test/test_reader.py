...
class PDBReadTest(IMP.test.TestCase):
    ...
    def test_saxs(self):
        ...
        #! read PDB
        mp= IMP.atom.PDBReader.read_PDB_file("input/input.pdb", m, IMP.atom.NonWaterSelector())
        print "number of particles"
        print m.get_number_of_particles()
        #IMP.core.show_molecular_hierarchy(mp)

        m2 = IMP.Model()
        mp= IMP.atom.PDBReader.read_PDB_file("input/input.pdb", m2, IMP.atom.CAlphaSelector())
        print "number of particles"
