...
std::string get_atom_name(std::string atom_name,
  ...
  if (!map_init) {
    ...
    IMP_GAN_INSERT("ARG", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("HD1", "HD2")(
                              "HD2", "HD3")("HG1", "HG2")("HG2", "HG3"));
    IMP_GAN_INSERT("ASN", ("HN", "H")("HB1", "HB2")("HB2", "HB3"));
    map["ASP"] = map["ASN"];
    IMP_GAN_INSERT("CYS", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("HG1", "HG"));
    IMP_GAN_INSERT("GLU", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("HG1", "HG2")(
                              "HG2", "HG3"));
    map["GLN"] = map["GLU"];
    IMP_GAN_INSERT("GLY", ("HN", "H")("HA1", "HA2")("HA2", "HA3"));
    IMP_GAN_INSERT("ILE",
                   ("HN", "H")("CD", "CD1")("HG11", "HG12")("HG12", "HG13")(
                       "HD1", "HD11")("HD2", "HD12")("HD3", "HD13"));
    IMP_GAN_INSERT("LEU", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("CD1", "CD2")(
                              "CD2", "CD1")("HD11", "HD21")("HD12", "HD22")(
                              "HD13", "HD23")("HD21", "HD11")("HD22", "HD12")(
                              "HD23", "HD13"));
    IMP_GAN_INSERT("LYS", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("HG1", "HG2")(
                              "HG2", "HG3")("HD1", "HD2")("HD2", "HD3")(
                              "HE1", "HE2")("HE2", "HE3"));
    IMP_GAN_INSERT("MET", ("HN", "H")("HB1", "HB2")("HB2", "HB3")("HG1", "HG2")(
                              "HG2", "HG3"));
    IMP_GAN_INSERT("PRO", ("HB1", "HB2")("HB2", "HB3")("HG1", "HG2")(
                              "HG2", "HG3")("HD1", "HD2")("HD2", "HD3"));
    IMP_GAN_INSERT("SER", ("HN", "H")("HG1", "HG")("HB1", "HB2")("HB2", "HB3"));
    IMP_GAN_INSERT("VAL", ("HN", "H"));
    map["THR"] = map["VAL"];
    IMP_GAN_INSERT("PHE", ("HN", "H")("HB1", "HB2")("HB2", "HB3"));
    map["TRP"] = map["TYR"] = map["HIS"] = map["PHE"];
    IMP_GAN_INSERT("TIP3", ("OH2", "O"));
    IMP_GAN_INSERT("CAL", ("CAL", "CA"));
    IMP_GAN_INSERT("ALA", ("HN", "H"));
    IMP_GAN_INSERT("NTER", ("HT1", "H")("HT2", "H2")("HT3", "H3"));
    IMP_GAN_INSERT("CTER", ("OT1", "O")("OT2", "OXT"));
    IMP_GAN_INSERT("GLYP", ("HT1", "H")("HT2", "H2")("HT3", "H3")("HA1", "HA2")(
                               "HA2", "HA3"));
    IMP_GAN_INSERT("PROP",
                   ("HN1", "H1")("HN2", "H2")("HD1", "HD2")("HD2", "HD3"));
    IMP_GAN_INSERT("DISU", ("1HB1", "1HB2")("1HB2", "1HB3")("2HB1", "2HB2")(
                               "2HB2", "2HB3")("1HG1", "1HG")("2HG1", "2HG"));
  }
...
template <class It>
Strings get_atom_names(It first, It last, CHARMMResidueTopologyBase *residue,
                       bool translate_names_to_pdb) {
  Strings ret;
  ...
  if (split_results[1] == "ATOM") {
    for (unsigned int i = 2; i < split_results.size(); ++i) {
      ...
      std::string atom_name =
          get_atom_name(split_results[i], patch, translate_names_to_pdb);
...
void parse_internal_coordinate_line(std::string line,
  ...
  Strings atom_names =
      get_atom_names(split_results.begin() + 1, split_results.begin() + 5,
  ...
  CHARMMInternalCoordinate ic(
      atom_names, atof(split_results[5].c_str()),
      atof(split_results[6].c_str()), atof(split_results[7].c_str()),
      atof(split_results[8].c_str()), atof(split_results[9].c_str()), improper);
...
void parse_patch_line(std::string line, std::string &first, std::string &last,
                      bool translate_names_to_pdb) {
...
void CHARMMParameters::parse_atom_line(const String &line,
  ...
  CHARMMAtomTopology atom(
      get_atom_name(split_results[1], residue, translate_names_to_pdb));
  ...
  if (AtomType::get_key_exists(imp_atom_name)) {
    ...
    imp_atom_type = add_atom_type(
        imp_atom_name,
        get_element_for_type(split_results[2], atom_type_to_element_));
  }
  // save in map
  ...
  atom_res_type_2_force_field_atom_type_[curr_res_type].insert(std::make_pair(
      imp_atom_type,
      std::make_pair(atom.get_charmm_type(), atom.get_charge())));
}
...
void CHARMMParameters::parse_bond_line(const String &line,
  ...
  for (unsigned int i = 1; i < split_results.size(); i += 2) {
    if (split_results[i][0] == '!') return;  // comments start
    Strings atom_names =
        get_atom_names(split_results.begin() + i, split_results.begin() + i + 2,
                       residue, translate_names_to_pdb);
...
void CHARMMParameters::parse_bonds_parameters_line(String line) {
  ...
  boost::split(split_results, line, boost::is_any_of(" \t"),
               boost::token_compress_on);
  if (split_results.size() < 4) return;  // bonds line has at least 4 fields
...
void CHARMMParameters::parse_angles_parameters_line(String line) {
  ...
  boost::split(split_results, line, boost::is_any_of(" \t"),
               boost::token_compress_on);
  if (split_results.size() < 5) return;  // angles line has at least 5 fields

  CHARMMBondParameters p;
  p.force_constant = atof(split_results[3].c_str());
  p.ideal = atof(split_results[4].c_str());
  angle_parameters_[internal::CHARMMAngleNames(
      split_results[0], split_results[1], split_results[2])] = p;
}

void CHARMMParameters::parse_dihedrals_parameters_line(
    String line, DihedralParameters &param) {
  Strings split_results;
  boost::split(split_results, line, boost::is_any_of(" \t"),
               boost::token_compress_on);
  if (split_results.size() < 7) return;  // dihedrals line has at least 7 fields
  ...
  param.push_back(std::make_pair(
      internal::CHARMMDihedralNames(split_results[0], split_results[1],
                                    split_results[2], split_results[3]),
      p));
}
