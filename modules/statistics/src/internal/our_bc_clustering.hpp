...
// boost/graph/bc_clustering.hpp from boost 1.71, to work around
// issue https://github.com/boostorg/graph/issues/175 (compilation fails
                                  ...
                                  VertexIndexMap vertex_index)
{
  ...
  do {
    ...
    edge_descriptor e = *boost::first_max_element(edges_iters.first,
                                                  edges_iters.second, cmp);
