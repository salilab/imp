 ...
 */
std::pair<int,int> split_by_plane(
...
If, however, the midpoint split produces a trivial split (no points on one side
...
less than the x-bisector, then the split is taken along the maximum x-coordinate
...
*/
  ...
  std::pair<double,double>
    limits_along_dimension(int start_ind, int end_ind, int dim);
