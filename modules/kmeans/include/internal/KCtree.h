...
class IMPKMEANSEXPORT KCnode  // generic kc-tree node
    {
 protected:
 ...
 public:
  KCnode(              // basic constructor
      ...
      : multCand(-1),
        bnd_box(dim, bb) {  // create bounding box
    sum = kmAllocPt(dim, 0);
    sumSq = 0;
  }
...
class IMPKMEANSEXPORT KCleaf : public KCnode {
 protected:
...
// splitting node of a kc-tree
class IMPKMEANSEXPORT KCsplit : public KCnode {
 protected:
...
#endif /* IMPKMEANS_INTERNAL_KCTREE_H */
