/**
 *  \file QuadsPredicateRestraint.cpp   \brief Container for quad.
 *
...
#include "IMP/container/QuadsPredicateRestraint.h"

IMPCONTAINER_BEGIN_NAMESPACE

QuadsPredicateRestraint
...
void QuadsPredicateRestraint::do_show(std::ostream &) const {
}
