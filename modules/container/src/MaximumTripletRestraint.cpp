/**
 *  \file MaximumTripletRestraint.cpp
...
#include "IMP/container/MaximumTripletRestraint.h"
...
void MaximumTripletRestraint::show(std::ostream &out) const {
