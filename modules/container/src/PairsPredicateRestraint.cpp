/**
 *  \file PairsPredicateRestraint.cpp   \brief Container for pair.
 *
...
#include "IMP/container/PairsPredicateRestraint.h"

IMPCONTAINER_BEGIN_NAMESPACE

PairsPredicateRestraint
...
void PairsPredicateRestraint::do_show(std::ostream &) const {
}
