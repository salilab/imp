...
void
QuadContainerStatistics::show_statistics(std::ostream &out) const {
...
ContainersTemp QuadContainerStatistics::get_output_containers() const {
  return ContainersTemp();
}
ParticlesTemp QuadContainerStatistics::get_input_particles() const {
