...
class SpacefillingVolumetric {
  ...
  */
  //\@{
  //! volume of a sector
  double sector_V(Wpoint const &, Wpoint const &, Wpoint const &,
                  Wpoint const &);
  //! area of a sector
  double sector_A(Wpoint const &, Wpoint const &, Wpoint const &,
                  Wpoint const &);
  //! volume of a wedge
  double wedge_V(Wpoint const &, Wpoint const &, Wpoint const &,
                 Wpoint const &);
  //! area of a wedge
  double wedge_A(Wpoint const &, Wpoint const &, Wpoint const &,
                 Wpoint const &);
  //! length of a wedge
  double wedge_L(Wpoint const &, Wpoint const &, Wpoint const &,
                 Wpoint const &);
  //! volume of a pawn
  ...
  //! tetrahedron volume
  double tetra_V(Wpoint const &, Wpoint const &, Wpoint const &,
                 Wpoint const &);
  //\@}
  ...
  */
  //\@{
  //! solid angle
  double solid_angle(Point const &, Point const &, Point const &,
                     Point const &);
  //! solid angle
  double dihedral_angle(Point const &, Point const &, Point const &,
                        Point const &);
  //! cross product
  ...
  */
  ...
  double triangle_diff_spheres(Wpoint const &i, Wpoint const &j,
                               Wpoint const &k);
  //! Computes the area and length of the part of a triangle that is not in any
  //! spheres composing the triangle
  void triangle_diff_spheres(Wpoint const &i, Wpoint const &j, Wpoint const &k,
                             double &A, double &L);
  //@}
};
//@}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::vector_squared_length(
    Vector const &v) {
 ...
 */
template <typename Gt>
inline typename SpacefillingVolumetric<Gt>::Vector SpacefillingVolumetric<
    Gt>::normalized_cross_product(Vector const &u, Vector const &v) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ball_A(Wpoint const &v) {
  double w = ball_R(v);
  return 4 * PI * w * w;
}
/*! ball radius
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ball_R(Wpoint const &v) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ball_R2(Wpoint const &v) {
  return v.weight();
}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter2_V(Wpoint const &i,
                                                       Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter2_A(Wpoint const &i,
                                                       Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter2_L(Wpoint const &i,
                                                       Wpoint const &j) {
  return disk_L(i, j);
}
/*! volume of the intersection of three balls
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter3_V(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter3_A(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter3_L(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter4_V(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k,
                                                       Wpoint const &l) {
  return capInter3_V(i, j, k, l) + capInter3_V(j, i, k, l) +
         capInter3_V(k, i, j, l) + capInter3_V(l, i, j, k);
}
/*! area of the intersection of four balls
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter4_A(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k,
                                                       Wpoint const &l) {
  return capInter3_A(i, j, k, l) + capInter3_A(j, i, k, l) +
         capInter3_A(k, i, j, l) + capInter3_A(l, i, j, k);
}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter4and3_V(Wpoint const &i,
                                                           Wpoint const &j,
                                                           Wpoint const &k,
                                                           Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter4and3_A(Wpoint const &i,
                                                           Wpoint const &j,
                                                           Wpoint const &k,
                                                           Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::ballInter4_L(Wpoint const &i,
                                                       Wpoint const &j,
                                                       Wpoint const &k,
                                                       Wpoint const &l) {
  return segmentInter2_L(i, j, k, l) + segmentInter2_L(i, k, l, j) +
         segmentInter2_L(i, l, j, k) + segmentInter2_L(j, k, i, l) +
         segmentInter2_L(j, l, k, i) + segmentInter2_L(k, l, i, j);
}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::sector_V(Wpoint const &i,
                                                   Wpoint const &j,
                                                   Wpoint const &k,
                                                   Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::sector_A(Wpoint const &i,
                                                   Wpoint const &j,
                                                   Wpoint const &k,
                                                   Wpoint const &l) {
  // TRACE(" sector_A");
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::wedge_V(Wpoint const &i,
                                                  Wpoint const &j,
                                                  Wpoint const &k,
                                                  Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::wedge_A(Wpoint const &i,
                                                  Wpoint const &j,
                                                  Wpoint const &k,
                                                  Wpoint const &l) {
  // TRACE(" wedge_A");
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::wedge_L(Wpoint const &i,
                                                  Wpoint const &j,
                                                  Wpoint const &k,
                                                  Wpoint const &l) {
  // TRACE(" wedge_L");
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::tetra_V(Wpoint const &i,
                                                  Wpoint const &j,
                                                  Wpoint const &k,
                                                  Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::cap_A(Wpoint const &i,
                                                Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::cap_H(Wpoint const &i,
                                                Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter2_V(Wpoint const &i,
                                                      Wpoint const &j,
                                                      Wpoint const &k) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter2_A(Wpoint const &i,
                                                      Wpoint const &j,
                                                      Wpoint const &k) {
  return 0.5 * ball_A(i) * (1 - dihedral_angle(i.point(), triangleDual(i, j, k),
                                               j.point(), k.point()) -
                            dihedral_angle(i.point(), triangleDual(i, k, j),
                                           j.point(), k.point())) -
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter3_V(Wpoint const &i,
                                                      Wpoint const &j,
                                                      Wpoint const &k,
                                                      Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter3and2_V(Wpoint const &i,
                                                          Wpoint const &j,
                                                          Wpoint const &kk,
                                                          Wpoint const &ll) {
  Wpoint k, l;
  ...
  center3ijl = orthoCenter(i, j, l);
  center3ikl = orthoCenter(i, k, l);
  dualijk = triangleDual(i, j, k);
  dualijl = triangleDual(i, j, l);
  dualikl = triangleDual(i, k, l);
  dualikj = triangleDual(i, k, j);
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter3_A(Wpoint const &i,
                                                      Wpoint const &j,
                                                      Wpoint const &kk,
                                                      Wpoint const &ll) {
  Wpoint k, l;
  ...
  double A2 = 2 * PI * ball_R(i) * segmentInter2_a(i, j, k, l) *
              (ball_R(i) - cap_H(i, j));
  double A3 = 2 * PI * ball_R(i) * segmentInter2_a(i, k, l, j) *
              (ball_R(i) - cap_H(i, k));
  double A4 = 2 * PI * ball_R(i) * segmentInter2_a(i, l, j, k) *
              (ball_R(i) - cap_H(i, l));
  return A1 - A2 - A3 - A4;
}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::capInter3and2_A(Wpoint const &i,
                                                          Wpoint const &j,
                                                          Wpoint const &k,
                                                          Wpoint const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::disk_A(Wpoint const &i,
                                                 Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::disk_L(Wpoint const &i,
                                                 Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::disk_R(Wpoint const &i,
                                                 Wpoint const &j) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::segment_A(Wpoint const &i,
                                                    Wpoint const &j,
                                                    Wpoint const &k) {
  double R = disk_R(i, j);
...
inline double SpacefillingVolumetric<Gt>::segment_a(Wpoint const &i,
                                                    Wpoint const &j,
                                                    Wpoint const &k) {
  return dihedral_angle(i.point(), j.point(), k.point(),
                        triangleDual(i, j, k)) +
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::segment_L(Wpoint const &i,
                                                    Wpoint const &j,
                                                    Wpoint const &k) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::segment_H(Wpoint const &i,
                                                    Wpoint const &j,
                                                    Wpoint const &k) {
  return is_hidden(i, j, k)
             ? (disk_R(i, j) +
                vector_length(orthoCenter(i, j) - orthoCenter(i, j, k)))
             : (disk_R(i, j) -
                vector_length(orthoCenter(i, j) - orthoCenter(i, j, k)));
}
/*! area of the intersection of two segments
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::segmentInter2_A(Wpoint const &i,
                                                          Wpoint const &j,
                                                          Wpoint const &kk,
                                                          Wpoint const &ll) {
  Wpoint k, l;
  ...
  return (disk_R(i, j) * segmentInter2_L(i, j, k, l) -
...
inline double SpacefillingVolumetric<Gt>::segmentInter2_a(Wpoint const &i,
  ...
  return dihedral_angle(i.point(), j.point(), k.point(),
                        triangleDual(i, k, j)) +
         dihedral_angle(i.point(), j.point(), l.point(),
                        triangleDual(i, j, l)) -
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::segmentInter2_L(Wpoint const &i,
                                                          Wpoint const &j,
                                                          Wpoint const &k,
                                                          Wpoint const &l) {
...
template <typename Gt>
inline typename SpacefillingVolumetric<Gt>::Point SpacefillingVolumetric<
    Gt>::triangleDual(Wpoint const &p, Wpoint const &q, Wpoint const &r) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::solid_angle(Point const &i,
                                                      Point const &j,
                                                      Point const &k,
                                                      Point const &l) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::dihedral_angle(Point const &i,
                                                         Point const &j,
                                                         Point const &k,
                                                         Point const &l) {
  Vector M1 = normalized_cross_product(k - i, k - j);
...
template <typename Gt>
inline typename SpacefillingVolumetric<Gt>::Vector
SpacefillingVolumetric<Gt>::cross_prod(Vector const &u, Vector const &v) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::dot_prod(Vector const &u,
                                                   Vector const &v) {
  return u * v;
}
/*! tells if i sees (j,k,l) in conter clock wise order
...
inline double SpacefillingVolumetric<Gt>::triangle_A(Point const &i,
                                                     Point const &j,
                                                     Point const &k) {
  return triangle_A(vector_length(i - j), vector_length(k - j),
                    vector_length(i - k));
}
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::triangle_A(double i, double j,
                                                     double k) {
  // double p=(i+j+k)/2.;
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::squared_triangle_A(double i, double j,
                                                             double k) {
  double p = (i + j + k) / 2.;
 ...
 */
template <typename Gt>
inline void SpacefillingVolumetric<Gt>::triangle_a(Point const &i,
                                                   Point const &j,
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::sector_A(Wpoint const &p, double a) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::sector_L(Wpoint const &p, double a) {
 ...
 */
template <typename Gt>
inline double SpacefillingVolumetric<Gt>::triangle_diff_spheres(
    Wpoint const &i, Wpoint const &j, Wpoint const &k) {
 ...
 */
template <typename Gt>
inline void SpacefillingVolumetric<Gt>::triangle_diff_spheres(
    Wpoint const &i, Wpoint const &j, Wpoint const &k, double &A, double &L) {
  double I, J, K;                       // angles at resp. i,j,k
  ...
  A = triangle_A(i, j, k) -
      PI * (I * ball_R2(i) + J * ball_R2(j) + K * ball_R2(k)) + Aij + Aik + Ajk;
  L = 2 * PI * (I * ball_R(i) + J * ball_R(j) + K * ball_R(k)) - Lij - Lik -
      Ljk;
}
...
// }
    ...
    for (std::list<Facet>::iterator cit = facets.begin(); cit != facets.end();
         ++cit) {
      tmpV += 0.5 * spacefill.ballInter3_V(
                        cit->first->vertex((cit->second + 1) & 3)->point(),
                        cit->first->vertex((cit->second + 2) & 3)->point(),
                        cit->first->vertex((cit->second + 3) & 3)->point());
      tmpA += 0.5 * spacefill.ballInter3_A(
                        cit->first->vertex((cit->second + 1) & 3)->point(),
                        cit->first->vertex((cit->second + 2) & 3)->point(),
                        cit->first->vertex((cit->second + 3) & 3)->point());
    }
