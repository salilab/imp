...
#include "IMP/core/MaximumQuadRestraint.h"
...
ParticlesList MaximumQuadRestraint::get_interacting_particles() const
{
  MS bestn= find_minimal_set(c_->particle_quads_begin(),
                             c_->particle_quads_end(), f_.get(), n_);
  ParticlesList ret;
...
ParticlesTemp MaximumQuadRestraint::get_input_particles() const
{
  return IMP::internal::get_input_particles(c_.get(), f_.get());
}

ContainersTemp MaximumQuadRestraint::get_input_containers() const
{
