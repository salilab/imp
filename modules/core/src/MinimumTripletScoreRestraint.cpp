/**
 *  \file MinimumTripletScoreRestraint.cpp
...
#include "IMP/core/MinimumTripletScoreRestraint.h"
...
namespace {
  typedef internal::MinimalSet<double,
    TripletContainer::ParticleTripletIterator> MS;
...
double MinimumTripletScoreRestraint
...
void MinimumTripletScoreRestraint::show(std::ostream &out) const {
  out << "MinimumTripletScoreRestraint over ";
  c_->show(out);
  out << " using function ";
  f_->show(out);
  out << std::endl;
...
ParticlesList MinimumTripletScoreRestraint::get_interacting_particles() const
{
  MS bestn= find_minimal_set(c_->particle_triplets_begin(),
                             c_->particle_triplets_end(), f_.get(), n_);
  ParticlesList ret;
...
ParticlesTemp MinimumTripletScoreRestraint::get_input_particles() const
{
  return IMP::internal::get_input_particles(c_.get(), f_.get());
}

ContainersTemp MinimumTripletScoreRestraint::get_input_containers() const
{
