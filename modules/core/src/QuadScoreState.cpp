...
#include "IMP/core/QuadScoreState.h"
#include "IMP/internal/container_helpers.h"

IMPCORE_BEGIN_NAMESPACE

QuadScoreState::QuadScoreState(QuadModifier *before,
                                         QuadModifier *after,
...
void QuadScoreState::do_before_evaluate()
{
  IMP_OBJECT_LOG;
  if (!f_) return;
...
void QuadScoreState::do_after_evaluate(DerivativeAccumulator *da)
{
  IMP_OBJECT_LOG;
  if (!af_) return;
...
ParticlesList QuadScoreState::get_interacting_particles() const {
...
ObjectsTemp QuadScoreState::get_input_objects() const {
  return ObjectsTemp();
}

ObjectsTemp QuadScoreState::get_output_objects() const {
  return ObjectsTemp();
}

ParticlesTemp QuadScoreState::get_input_particles() const {
  ParticlesTemp ret;
  if (f_) {
...
ParticlesTemp QuadScoreState::get_output_particles() const {
  ParticlesTemp ret;
  if (f_) {
...
void QuadScoreState::show(std::ostream &out) const {
  out << "QuadScoreState with ";
  if (f_) out << *f_;
  else out << "NULL";
  out << " and ";
  if (af_) out << *af_;
