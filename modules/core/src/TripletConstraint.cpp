...
ContainersTemp TripletConstraint::get_input_containers() const {
  return ContainersTemp();
}

ContainersTemp TripletConstraint::get_output_containers() const {
  return ContainersTemp();
}
...
void TripletConstraint::do_show(std::ostream &out) const {
