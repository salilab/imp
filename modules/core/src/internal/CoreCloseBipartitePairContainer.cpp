/**
 *  \file CloseBipartitePairContainer.cpp   \brief A list of kernel::ParticlePairs.
 *
...
CoreCloseBipartitePairContainer::CoreCloseBipartitePairContainer(
  ...
  initialize(a, b, base::get_invalid_index<kernel::ParticleIndexTag>(),
             base::get_invalid_index<kernel::ParticleIndexTag>(), distance, slack, key);
}

CoreCloseBipartitePairContainer::CoreCloseBipartitePairContainer(
    kernel::SingletonContainer *a, kernel::SingletonContainer *b, kernel::ParticleIndex cover_a,
    kernel::ParticleIndex cover_b, kernel::ObjectKey key, double distance, double slack,
    std::string name)
    : P(a->get_model(), name) {
...
void CoreCloseBipartitePairContainer::initialize(
    kernel::SingletonContainer *a, kernel::SingletonContainer *b, kernel::ParticleIndex cover_a,
    kernel::ParticleIndex cover_b, double distance, double slack, kernel::ObjectKey key) {
  IMP_OBJECT_LOG;
  slack_ = slack;
  distance_ = distance;
  key_ = key;
