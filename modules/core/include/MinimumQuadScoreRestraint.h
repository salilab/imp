/**
 *  \file MinimumQuadScoreRestraint.h
...
#ifndef IMPCORE_MINIMUM_QUAD_SCORE_RESTRAINT_H
#define IMPCORE_MINIMUM_QUAD_SCORE_RESTRAINT_H
...
//! Score based on the minimum over a set of Quads
/** The score is evaluated for each of the Quads in the container
    ...
    \see MaximumQuadScoreRestraint
 */
class IMPCOREEXPORT MinimumQuadScoreRestraint
: public Restraint
{
...
public:
  ...
  MinimumQuadScoreRestraint(QuadScore *f,
                                 ...
                                 unsigned int n=1,
                                 std::string name
                                 ="MinimumQuadScoreRestraint %1%");

  IMP_RESTRAINT(MinimumQuadScoreRestraint, get_module_version_info());
...
#endif  /* IMPCORE_MINIMUM_QUAD_SCORE_RESTRAINT_H */
