...
class AttributeSingletonPredicate: public SingletonPredicate {
  IntKey bb_;
 public:
  AttributeSingletonPredicate(IntKey bb,
                              std::string name
...
inline double PredicateSingletonScore<Predicate, Score>
::evaluate_index(Model *m, ParticleIndex p,
...
create_predicates_singleton_score(Predicate *pred,
                                  int val, Score *score) {
