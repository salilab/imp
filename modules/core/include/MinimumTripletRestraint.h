...
#ifndef IMPCORE_MINIMUM_TRIPLET_RESTRAINT_H
#define IMPCORE_MINIMUM_TRIPLET_RESTRAINT_H
 ...
 */
class IMPCOREEXPORT MinimumTripletRestraint
: public Restraint
{
...
#endif  /* IMPCORE_MINIMUM_TRIPLET_RESTRAINT_H */
