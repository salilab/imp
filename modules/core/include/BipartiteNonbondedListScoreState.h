...
#ifndef __IMPCORE_BIPARTITE_NONBONDED_LIST_SCORE_STATE_H
#define __IMPCORE_BIPARTITE_NONBONDED_LIST_SCORE_STATE_H
...
#endif  /* __IMPCORE_BIPARTITE_NONBONDED_LIST_SCORE_STATE_H */
