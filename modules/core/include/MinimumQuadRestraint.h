...
#ifndef IMPCORE_MINIMUM_QUAD_RESTRAINT_H
#define IMPCORE_MINIMUM_QUAD_RESTRAINT_H
 ...
 */
class IMPCOREEXPORT MinimumQuadRestraint
: public Restraint
{
...
#endif  /* IMPCORE_MINIMUM_QUAD_RESTRAINT_H */
