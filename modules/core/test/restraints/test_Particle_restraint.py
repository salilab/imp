...
class ParticleContainerTest(IMP.test.TestCase):
    ...
    def dont_submit_test_filter(self):
        ...
        for i in range(0,10):
            c.add_particle(self.create_particle(m))
        print "done 2"
        for p in f.get_singletons():
            c.add_particle(p)
        self.assertEqual(c.get_number_of_singletons(), 10)
        print "all done"
    ...
    def dont_submit_test_set(self):
        ...
        for i in range(0,3):
            ...
            for j in range(0,3):
                ...
                cs.append(t)
        for p in cs:
            self.assert_(c.get_contains_singleton(p))
        ret=[]
        for i in range(0, len(cs)):
            ret.append(c.get_singleton(i))
        ...
        self.assertEqual(c.get_number_of_singletons(), len(cs))
