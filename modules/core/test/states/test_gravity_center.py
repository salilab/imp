...
class TestGravityCenter(IMP.test.TestCase):
    ...
    def _make_gravity_center(self, model, x, y, z, weighted):
        ...
        if weighted:
            gc = IMP.core.GravityCenterScoreState(center, masskey, ps)
        else:
            gc = IMP.core.GravityCenterScoreState(center, IMP.FloatKey(), ps)
    ...
    def test_optimize(self):
        ...
        (ps2, cen2, gc2) = self._make_gravity_center(model, 0.0, 0.0, 0.0,
                                                     True)
        r = IMP.core.DistanceRestraint(IMP.core.Harmonic(0.2, 7000.0),
                                       cen1, cen2)
