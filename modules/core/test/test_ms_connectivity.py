...
class MSConnectivityTests(IMP.test.TestCase):
    ...
    def setUp(self):
        ...
        class_a = self.r.add_type([self.ds[0], self.ds[1]])
        class_b = self.r.add_type([self.ds[2], self.ds[3]])
        class_c = self.r.add_type([self.ds[4]])
        class_d = self.r.add_type([self.ds[5]])
        i1 = self.r.add_composite([class_a, class_a, class_b, class_b, class_c])
        i2 = self.r.add_composite([class_a, class_b, class_b, class_c], i1)
        i3 = self.r.add_composite([class_a, class_a, class_b, class_b], i1)
        i4 = self.r.add_composite([class_a, class_b], i1)
        i5 = self.r.add_composite([class_a, class_b, class_b], i2)
        i6 = self.r.add_composite([class_b, class_c], i2)
        i7 = self.r.add_composite([class_a, class_a, class_b], i3)
        i8 = self.r.add_composite([class_a, class_b], i5)
