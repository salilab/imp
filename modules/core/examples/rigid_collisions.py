...
# Collision detection and building of a non-bonded list can be sped up when
# rigid bodies are used. To do this, use a RigidClosePairsFinder.
...
nbl = IMP.container.ClosePairContainer(
    lsc, 0, IMP.core.RigidClosePairsFinder(), 2.0)
