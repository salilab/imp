...
class IMPMULTIFITEXPORT ComponentHeader : public IMP::base::Object {
 public:
  ...
  inline std::string get_txt_fine_ap_fn() const { return pdb_fine_ap_fn_; }
...
class IMPMULTIFITEXPORT AssemblyHeader : public IMP::base::Object {
 public:
  ...
  void set_coarse_ap_fn(const std::string &new_fn) { coarse_ap_fn_ = new_fn; }
  ...
  void set_fine_ap_fn(const std::string &new_fn) { fine_ap_fn_ = new_fn; }
...
class IMPMULTIFITEXPORT SettingsData : public IMP::base::Object {
 public:
  ...
  void set_assembly_filename(const std::string &fn) { asmb_fn_ = fn; }
  const char *get_assembly_filename() const { return asmb_fn_.c_str(); }
  void set_assembly_header(AssemblyHeader *h) { dens_data_ = h; }
  AssemblyHeader *get_assembly_header() const { return dens_data_; }
  void set_data_path(const std::string &fn) { data_path_ = fn; }
  std::string get_data_path() const { return data_path_; }

  IMP_OBJECT_METHODS(SettingsData);

  IMP_LIST_ACTION(public, ComponentHeader, ComponentHeaders, component_header,
                  component_headers, ComponentHeader *, ComponentHeaders,
...
IMPMULTIFITEXPORT void write_settings(const char *filename,
                                      const SettingsData *sd);
