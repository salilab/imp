...
class Tests(IMP.test.TestCase):
    ...
    def test_align_run(self):
        ...
        class DummyAlignment(old_align):
            def set_density_map(self, dmap, threshold): pass
            def add_states_and_filters(self): pass
            def add_all_restraints(self): pass
            def align(self): pass
            def get_combinations(self): return []
        try:
