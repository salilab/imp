...
""" % (self.get_input_file_name("twoblobsA.pdb"),
        ...
        pts.sort()
        self.assertAlmostEqual(pts[0][0], 24.0, delta=2.0)
        self.assertAlmostEqual(pts[0][1], 11.6, delta=2.0)
        self.assertAlmostEqual(pts[0][2], 8.2, delta=2.0)
        self.assertAlmostEqual(pts[1][0], 26.7, delta=2.0)
        self.assertAlmostEqual(pts[1][1], 14.6, delta=2.0)
        self.assertAlmostEqual(pts[1][2], 5.1, delta=2.0)
