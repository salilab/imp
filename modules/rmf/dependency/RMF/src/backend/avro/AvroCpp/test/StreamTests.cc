...
init_unit_test_suite( int argc, char* argv[] ) 
{
    ...
    ts->add(BOOST_TEST_CASE(
        &rmf_avro::stream::testEmpty_memoryStream<rmf_avro::stream::CheckEmpty1>));
    ts->add(BOOST_TEST_CASE(
        &rmf_avro::stream::testEmpty_memoryStream<rmf_avro::stream::CheckEmpty2>));
    ...
    ts->add(BOOST_PARAM_TEST_CASE(&rmf_avro::stream::testNonEmpty2,
        rmf_avro::stream::data,
        rmf_avro::stream::data +
        sizeof(rmf_avro::stream::data) / sizeof(rmf_avro::stream::data[0])));
