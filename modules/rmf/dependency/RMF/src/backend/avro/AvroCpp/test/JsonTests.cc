...
init_unit_test_suite( int argc, char* argv[] ) 
{
    ...
    ts->add(BOOST_PARAM_TEST_CASE(&rmf_avro::json::testPrimitive<bool>,
        rmf_avro::json::boolData,
        rmf_avro::json::boolData + COUNTOF(rmf_avro::json::boolData)));
    ts->add(BOOST_PARAM_TEST_CASE(&rmf_avro::json::testPrimitive<int64_t>,
        rmf_avro::json::longData,
        rmf_avro::json::longData + COUNTOF(rmf_avro::json::longData)));
    ts->add(BOOST_PARAM_TEST_CASE(&rmf_avro::json::testDouble,
        rmf_avro::json::doubleData,
        rmf_avro::json::doubleData + COUNTOF(rmf_avro::json::doubleData)));
    ts->add(BOOST_PARAM_TEST_CASE(&rmf_avro::json::testString,
        rmf_avro::json::stringData,
