/**
 * \file AttributeMap1ScoreState.h
...
#ifndef IMPSEARCH_ATTRIBUTE_MAP_1SCORE_STATE_H
#define IMPSEARCH_ATTRIBUTE_MAP_1SCORE_STATE_H
...
class AttributeMap1ScoreState : public ScoreState
{
  typedef
...
public:
  ...
  */
  ...
  const Particles &get_particles(Value0 v0)  const {
    Values vs( v0);
   ...
   */
  const Particle* get_particle(Value0 v0)  const {
    Values vs( v0);
  ...
  */
  ...
  ~AttributeMap1ScoreState(){}

};

IMPSEARCH_END_NAMESPACE

#endif  /* IMPSEARCH_ATTRIBUTE_MAP_1SCORE_STATE_H */
