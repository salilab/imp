/**
 * \file AttributeMap4ScoreState.h
...
#ifndef IMPSEARCH_ATTRIBUTE_MAP_4SCORE_STATE_H
#define IMPSEARCH_ATTRIBUTE_MAP_4SCORE_STATE_H
...
class AttributeType3>
class AttributeMap4ScoreState : public ScoreState
{
  typedef
  typename boost::tuple<typename internal::GetKey<AttributeType0>::Key,
                                ...
                                typename internal::GetKey<AttributeType3>::Key>
    Keys;
  ...
  struct Bin {
    ...
    bool operator<(const Bin &o) const {
      ...
      else if (boost::get<3>(values) < boost::get<3>(o.values)) return true;
      else if (boost::get<3>(values) > boost::get<3>(o.values)) return false;
      return false;
    }
    bool operator==(const Bin &o) const {
      return boost::get<0>(values) == boost::get<0>(o.values)
           ...
           && boost::get<3>(values) == boost::get<3>(o.values);
    }
  };
...
public:
  ...
  typedef typename internal::GetKey<AttributeType3>::Key Key3;
  typedef AttributeType3 Value3;
  ...
  */
  ...
  const Particles get_particles(Value0 v0,
                                ...
                                Value0 vu0,
                                 ...
                                 Value2 vu2,
                                 Value3 vu3) const {
    Values vs0( v0,  v1,  v2,  v3), vs1( vu0,  vu1,  vu2,  vu3);
  ...
  */
  ...
  ~AttributeMap4ScoreState(){}

};

IMPSEARCH_END_NAMESPACE

#endif  /* IMPSEARCH_ATTRIBUTE_MAP_4SCORE_STATE_H */
