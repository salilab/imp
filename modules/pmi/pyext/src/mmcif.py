...
class ProtocolOutput(IMP.pmi.output.ProtocolOutput):
    ...
    def __init__(self):
        ...
        self.system = ihm.System(model_details=self._get_model_details())
    ...
    def _get_model_details(self):
        """Return a more detailed description of the modeling."""
        tm = time.strftime("%c")
        return "Generated by the Integrative Modeling Platform (IMP) on " + tm
