\brief Several general purpose optimizers from the GNU Scientific Library ([GSL](https://www.gnu.org/software/gsl/)).
...
# GSL # {#GSL}
The IMP.gsl module requires [GSL](https://www.gnu.org/software/gsl/). It
