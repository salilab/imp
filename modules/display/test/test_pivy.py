...
class Tests(IMP.test.TestCase):
    ...
    def test_5(self):
        ...
        g0 = IMP.display.SphereGeometry(
            IMP.algebra.Sphere3D(IMP.algebra.Vector3D(10, 10, 10), 3))
        g0.set_color(IMP.display.Color(0, 1, 0))
        g1 = IMP.display.SphereGeometry(
            IMP.algebra.Sphere3D(IMP.algebra.Vector3D(1, 1, 1), 2))
        ...
        gx = IMP.display.SphereGeometry(
            IMP.algebra.Sphere3D(IMP.algebra.Vector3D(3, 0, 0), 1))
        gx.set_color(IMP.display.Color(1, 0, 0))
        gy = IMP.display.SphereGeometry(
            IMP.algebra.Sphere3D(IMP.algebra.Vector3D(0, 3, 0), 1))
        gy.set_color(IMP.display.Color(0, 1, 0))
        gz = IMP.display.SphereGeometry(
            IMP.algebra.Sphere3D(IMP.algebra.Vector3D(0, 0, 3), 1))
