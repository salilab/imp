...
#our project
from IMP.isd import RegularRepulsiveDistancePairScore

#unit testing framework
import IMP.test

class TestRegularRepulsiveDistancePairScoreSimple(IMP.test.TestCase):
    "simple test cases to check if RegularRepulsiveDistancePairScore works"
    def setUp(self):
	...
	self.sf = IMP.atom.ForceSwitch(8.0, 10.0)
	self.e  = 2.0	
        self.ps = RegularRepulsiveDistancePairScore(self.e,self.sf)
	...
	r1 = p1.get_radius()
        for i in xrange(100):
            ...
            r=IMP.core.get_distance(p0,p1)
	    dist=r+r0+r1
	    distr30=(dist/(r0+r1))**30
            expected = self.e / ( 1.0 + distr30)
	...
	r1 = p1.get_radius()
	    ...
	    dist=r+r0+r1
	    distr30=(dist/(r0+r1))**30
            expected = -30.0 * self.e * distr30 / dist / ( 1.0 + distr30)**2
