...
di={'ALA': {'HB': ('HB1', 'HB2', 'HB3'),
 ...
 'ASN': {'HB': ('HB1', 'HB2'),
         ...
         'QD': ('HD21', 'HD22'),
         'QD2': ('HD21', 'HD22')},
 'ASP': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'CYS': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'GLN': {'HB': ('HB1', 'HB2'),
         'HB%': ('HB1', 'HB2'),
         'HE': ('HE21', 'HE22'),
         'HE%': ('HE21', 'HE22'),
 ...
 'GLU': {'HB': ('HB1', 'HB2'),
         ...
         'QB': ('HB1', 'HB2'),
         'QG': ('HG1', 'HG2')},
 'GLY': {'HA': ('HA1', 'HA2'), 'HA%': ('HA1', 'HA2'), 'QA': ('HA1', 'HA2')},
 'HIS': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'HSD': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'HSE': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'HSP': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'ILE': {'HD': ('HD1', 'HD2', 'HD3'),
         'HD%': ('HD1', 'HD2', 'HD3'),
         'HD1': ('HD1', 'HD2', 'HD3'),
         'HD1%': ('HD1', 'HD2', 'HD3'),
 ...
 'PRO': {'HB': ('HB1', 'HB2'),
         ...
         'QD': ('HD1', 'HD2'),
         'QG': ('HG1', 'HG2')},
 'SER': {'HB': ('HB1', 'HB2'), 'HB%': ('HB1', 'HB2'), 'QB': ('HB1', 'HB2')},
 'THR': {'HB': ('HB',),
         'HB%': ('HB',),
         'HG2': ('HG21', 'HG22', 'HG23'),
         'HG2%': ('HG21', 'HG22', 'HG23'),
