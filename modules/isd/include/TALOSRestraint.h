...
class IMPISDEXPORT TALOSRestraint : public Restraint {
 public:
   ...
   */
  TALOSRestraint(Model *m, Particles p, Floats data,
                 Particle *kappa);
  ...
  /** \param[in] m the Model
      ...
      \param[in] kappa Pointer to the \f$\kappa\f$ concentration particle.
   */
  TALOSRestraint(Model *m, Particle *p1, Particle *p2,
                 Particle *p3, Particle *p4, Floats data,
                 Particle *kappa);
  ...
  /** \param[in] m the Model
      ...
      \param[in] kappa Pointer to the \f$\kappa\f$ concentration particle.
   */
  TALOSRestraint(Model *m, Particles p, unsigned N, double R0,
   ...
   */
  TALOSRestraint(Model *m, Particle *p1, Particle *p2,
                 Particle *p3, Particle *p4, unsigned N,
                 double R0, double chiexp, Particle *kappa);
