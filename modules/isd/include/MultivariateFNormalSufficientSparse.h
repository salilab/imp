/**
 *  \file MultivariateFNormalSufficientSparse.h    \brief Normal distribution of Function
 *
 ...
 * in sparse format.  Will use symmetry by only considering the upper corner.
