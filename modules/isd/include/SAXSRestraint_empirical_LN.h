...
#ifndef IMPISD_SAXS_RESTRAINT_EMPIRICAL_LN_H
#define IMPISD_SAXS_RESTRAINT_EMPIRICAL_LN_H
 ...
 */
class IMPISDEXPORT SAXSRestraint_empirical_LN : public ISDRestraint
{
 public:
  //! Constructor
  /**
  ...
  */
  SAXSRestraint_empirical_LN(const Particles& particles, const Scale& sigma, const
          Scale& gamma, const saxs::Profile& exp_profile, saxs::FormFactorType ff_type = saxs::HEAVY_ATOMS);

  IMP_RESTRAINT(SAXSRestraint_empirical_LN);
...
#endif  /* IMPISD_SAXS_RESTRAINT_EMPIRICAL_LN_H */
