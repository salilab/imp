...
#ifndef IMPISD_SAXS_RESTRAINT_EMPIRICAL_MULTIPLE_N_H
#define IMPISD_SAXS_RESTRAINT_EMPIRICAL_MULTIPLE_N_H
...
/** \ingroup exp_restraint
    ...
    \prod_{q=q_{min}}^{q_{max}} \frac{1}{\sigma_{exp}(q)\sigma(q)}
 ...
 */
class IMPISDEXPORT SAXSRestraint_empirical_multiple_N : public ISDRestraint
{
 public:
  //! Constructor
  /**
  ...
  */
  SAXSRestraint_empirical_multiple_N(const Particles& particles, const Scales& sigmas, const
          Scale& gamma, const saxs::Profile& exp_profile, saxs::FormFactorType ff_type = saxs::HEAVY_ATOMS);

  IMP_RESTRAINT(SAXSRestraint_empirical_multiple_N);
...
#endif  /* IMPISD_SAXS_RESTRAINT_EMPIRICAL_MULTIPLE_N_H */
