...
#ifndef IMPISD_SAXS_RESTRAINT_LN_H
#define IMPISD_SAXS_RESTRAINT_LN_H
...
/** \ingroup exp_restraint
    ...
    \exp left[ - \frac{I_{exp}^2(q)}{2\alpha^2\sigma^2_{exp}(q)} 
 ...
 */
class IMPISDEXPORT SAXSRestraint_LN : public ISDRestraint
{
 public:
  //! Constructor
  /**
  ...
  */
  SAXSRestraint_LN(const Particles& particles, const Scale& alpha, const
          Scale& gamma, const saxs::Profile& exp_profile, saxs::FormFactorType ff_type = saxs::HEAVY_ATOMS);

  IMP_RESTRAINT(SAXSRestraint_LN);
...
#endif  /* IMPISD_SAXS_RESTRAINT_LN_H */
