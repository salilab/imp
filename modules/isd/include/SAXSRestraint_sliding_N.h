...
#ifndef IMPISD_SAXS_RESTRAINT_SLIDING_N_H
#define IMPISD_SAXS_RESTRAINT_SLIDING_N_H
...
/** \ingroup exp_restraint
    ...
    \f[p(D | X,\gamma, q_0, \alpha_\text{Good},\alpha_\text{Bad}, I) = 
 ...
 */
class IMPISDEXPORT SAXSRestraint_sliding_N : public ISDRestraint
{
 public:
  //! Constructor
  /**
  ...
  */
  SAXSRestraint_sliding_N(const Particles& particles, const Scale& gamma, const Scale& alphag, 
          const Scale& alphab, const Scale& q0,
          const saxs::Profile& exp_profile, saxs::FormFactorType ff_type = saxs::HEAVY_ATOMS);

  IMP_RESTRAINT(SAXSRestraint_sliding_N);
...
#endif  /* IMPISD_SAXS_RESTRAINT_SLIDING_N_H */
