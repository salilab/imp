/**
 *  \file SAXSRestraint_empirical_multiple_N.h
...
#include <IMP/isd/SAXSRestraint_empirical_multiple_N.h>
...
SAXSRestraint_empirical_multiple_N::SAXSRestraint_empirical_multiple_N(const Particles& particles, const Scales& sigmas,
...
ParticlesTemp SAXSRestraint_empirical_multiple_N::get_input_particles() const
{
...
ContainersTemp SAXSRestraint_empirical_multiple_N::get_input_containers() const
{
...
void SAXSRestraint_empirical_multiple_N::compute_profile(saxs::Profile& model_profile) {
...
/** \param[in] acc If true (not NULL), partial first derivatives should be
    ...
    \return score associated with this restraint for the given state of
            the model.
*/
double SAXSRestraint_empirical_multiple_N::unprotected_evaluate(DerivativeAccumulator *acc) const
{
  IMP_LOG(TERSE, "SAXSRestraint_empirical_multiple_N::unprotected_evaluate\n");

  /* compute Icalc */
  saxs::Profile model_profile(exp_profile_.get_min_q(),
                            exp_profile_.get_max_q(),
                            exp_profile_.get_delta_q());
  const_cast<SAXSRestraint_empirical_multiple_N*>(this)->compute_profile(model_profile);
...
void SAXSRestraint_empirical_multiple_N::do_show(std::ostream&) const
{
//   out << "SAXSRestraint_empirical_multiple_N: for " << particles_.size() << " particles "
