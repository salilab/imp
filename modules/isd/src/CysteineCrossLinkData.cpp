...
double CysteineCrossLinkData::get_omega_prior(double omega,
                                              double omega0) const {
  double prior = 0.0;
  if (prior_type_ == 0) {
    // jeffrey's prior
...
double CysteineCrossLinkData::get_nonmarginal_element(double fexp, double fmod,
                                                      double omega) const {
...
double CysteineCrossLinkData::get_marginal_element(double fmod,
                                                   double omega0) const {
  unsigned is = get_closest(omega0_grid_, omega0);
...
double CysteineCrossLinkData::get_element(double fexp, double fmod,
                                          double omega) const {
