...
/** Import IMP::kernel::DependencyGraph
    in the IMP namespace.*/
typedef IMP::kernel::DependencyGraph DependencyGraph;
/** Import IMP::kernel::DerivativeAccumulator
    in the IMP namespace.*/
typedef IMP::kernel::DerivativeAccumulator DerivativeAccumulator;
/** Import IMP::kernel::EvaluationState
    in the IMP namespace.*/
typedef IMP::kernel::EvaluationState EvaluationState;
/** Import IMP::kernel::EvaluationStates
    in the IMP namespace.*/
typedef IMP::kernel::EvaluationStates EvaluationStates;
...
/** Import IMP::kernel::ParticleIndexKey
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexKey ParticleIndexKey;
/** Import IMP::kernel::ParticleIndexKeys
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexKeys ParticleIndexKeys;
/** Import IMP::kernel::ParticleIndexPairs
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexPairs ParticleIndexPairs;
/** Import IMP::kernel::ParticleIndexQuads
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexQuads ParticleIndexQuads;
/** Import IMP::kernel::ParticleIndexTriplets
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexTriplets ParticleIndexTriplets;
/** Import IMP::kernel::ParticleIndexes
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexes ParticleIndexes;
/** Import IMP::kernel::ParticleIndexesKey
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexesKey ParticleIndexesKey;
/** Import IMP::kernel::ParticleIndexesKeys
    in the IMP namespace.*/
typedef IMP::kernel::ParticleIndexesKeys ParticleIndexesKeys;
/** Import IMP::kernel::ParticlePair
    in the IMP namespace.*/
typedef IMP::kernel::ParticlePair ParticlePair;
/** Import IMP::kernel::ParticlePairsTemp
    in the IMP namespace.*/
typedef IMP::kernel::ParticlePairsTemp ParticlePairsTemp;
/** Import IMP::kernel::ParticleQuad
    in the IMP namespace.*/
typedef IMP::kernel::ParticleQuad ParticleQuad;
/** Import IMP::kernel::ParticleQuadsTemp
    in the IMP namespace.*/
typedef IMP::kernel::ParticleQuadsTemp ParticleQuadsTemp;
/** Import IMP::kernel::ParticleTriplet
    in the IMP namespace.*/
typedef IMP::kernel::ParticleTriplet ParticleTriplet;
/** Import IMP::kernel::ParticleTripletsTemp
    in the IMP namespace.*/
typedef IMP::kernel::ParticleTripletsTemp ParticleTripletsTemp;
/** Import IMP::kernel::PythonRestraint
    in the IMP namespace.*/
typedef IMP::kernel::PythonRestraint PythonRestraint;
/** Import IMP::kernel::PythonScoreState
    in the IMP namespace.*/
typedef IMP::kernel::PythonScoreState PythonScoreState;
...
/** Import IMP::kernel::RestraintStatistics
    in the IMP namespace.*/
typedef IMP::kernel::RestraintStatistics RestraintStatistics;
/** Import IMP::kernel::RestraintStatisticsList
    in the IMP namespace.*/
typedef IMP::kernel::RestraintStatisticsList RestraintStatisticsList;
...
/** Import IMP::kernel::ScopedRemoveRestraint
    in the IMP namespace.*/
typedef IMP::kernel::ScopedRemoveRestraint ScopedRemoveRestraint;
/** Import IMP::kernel::ScopedRemoveScoreState
    in the IMP namespace.*/
typedef IMP::kernel::ScopedRemoveScoreState ScopedRemoveScoreState;
/** Import IMP::kernel::ScopedRestraint
    in the IMP namespace.*/
typedef IMP::kernel::ScopedRestraint ScopedRestraint;
/** Import IMP::kernel::ScopedScoreState
    in the IMP namespace.*/
typedef IMP::kernel::ScopedScoreState ScopedScoreState;
/** Import IMP::kernel::ScopedSetFloatAttribute
    in the IMP namespace.*/
typedef IMP::kernel::ScopedSetFloatAttribute ScopedSetFloatAttribute;
/** Import IMP::kernel::ScoreAccumulator
    in the IMP namespace.*/
typedef IMP::kernel::ScoreAccumulator ScoreAccumulator;
/** Import IMP::kernel::ScoreAccumulators
    in the IMP namespace.*/
typedef IMP::kernel::ScoreAccumulators ScoreAccumulators;
...
/** Import IMP::kernel::ScoringFunction
    in the IMP namespace.*/
typedef IMP::kernel::ScoringFunction ScoringFunction;
/** Import IMP::kernel::SingletonContainer
    in the IMP namespace.*/
typedef IMP::kernel::SingletonContainer SingletonContainer;
/** Import IMP::kernel::SingletonModifier
    in the IMP namespace.*/
typedef IMP::kernel::SingletonModifier SingletonModifier;
/** Import IMP::kernel::SingletonPredicate
    in the IMP namespace.*/
typedef IMP::kernel::SingletonPredicate SingletonPredicate;
...
/** Import IMP::kernel::TripletContainer
    in the IMP namespace.*/
typedef IMP::kernel::TripletContainer TripletContainer;
/** Import IMP::kernel::TripletModifier
    in the IMP namespace.*/
typedef IMP::kernel::TripletModifier TripletModifier;
/** Import IMP::kernel::TripletPredicate
    in the IMP namespace.*/
typedef IMP::kernel::TripletPredicate TripletPredicate;
