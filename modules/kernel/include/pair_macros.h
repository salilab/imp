...
#define IMP_PAIR_SCORE_BASE(Name)                                 \
  IMP_IMPLEMENT_INLINE(double evaluate(const ParticlePairsTemp &ps,    \
...
public:                                                                 \
 IMP_IMPLEMENT(bool get_contains(const ParticlePair& p) const); \
