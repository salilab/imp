...
typedef Divide<Piconewton, Angstrom>::type PiconewtonPerAngstrom;
...
typedef Multiply<Multiply<Centimeter, Centimeter>::type, Centimeter>::type
    CubicCentimeter;
typedef Multiply<Multiply<Angstrom, Angstrom>::type, Angstrom>::type
    CubicAngstrom;
...
inline KilocaloriePerMol operator*(Unit<internal::MKSTag, EXP, HeatEnergy> k,
  ...
  return KilocaloriePerMol(k.get_exponential_value() * NA);
}
...
template <int EXP>
inline Unit<internal::MKSTag, EXP - 26, Mass> convert_to_mks(
    Unit<internal::DaltonTag, EXP, SingletonUnit> d) {
  return Unit<internal::MKSTag, EXP - 26, Mass>(d.get_value() / NA.get_value());
}

template <int EXP>
inline Unit<internal::DaltonTag, EXP + 26, SingletonUnit> convert_to_Dalton(
    Unit<internal::MKSTag, EXP, Mass> d) {
  return Unit<internal::DaltonTag, EXP + 26, SingletonUnit>(d.get_value() *
                                                            NA.get_value());
}
