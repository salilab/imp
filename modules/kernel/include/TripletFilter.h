...
public:
   ...
   */
  virtual bool get_contains(const ParticleTriplet& p) const =0;

  /** \note This function may be linear. Be aware of the complexity
      bounds of your particular filter.
   */
  virtual bool get_contains(Model *m,
                            const ParticleIndexTriplet& p) const {
  ...
  */
  ...
  virtual void filter_in_place(Model *m, ParticleIndexTriplets& ps) const;
