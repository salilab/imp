/**
 *  \file IMP/Vector3D.h   \brief Simple 3D vector class.
 *
 *  Copyright 2007-2026 IMP Inventors. All rights reserved.
 *
 */

#ifndef IMPKERNEL_VECTOR_3D_H
#define IMPKERNEL_VECTOR_3D_H
...
inline double get_radius_of_gyration(const Vector3Ds &ps) {
  Vector3D centroid = get_centroid(ps);
  double rg = 0;
