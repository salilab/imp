...
class RotamerTest(IMP.test.TestCase):
    ...
    def test_query1(self):
        ...
        v = self.rl.get_rotamer_vector(IMP.atom.ResidueType("ARG"), -180, -180, 0.5)
        # the number of elements that sum to at least 0.5: 3
    ...
    def test_query2(self):
        ...
        v = self.rl.get_rotamer_vector(IMP.atom.ResidueType("VAL"), 180, 90, 0.5)
