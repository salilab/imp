...
class Tests(IMP.test.TestCase):
    ...
    def setUp(self):
        ...
        RestraintParser = IMP.restrainer.XMLRestraint(
            self.get_input_file_name('pdb_connectivity_restraint.xml'))
    ...
    def test_show(self):
        ...
        connectivity_restraint = self.restraint.get_restraint_by_name(
            restraint_name).imp_restraint
        connectivity_restraint.show()

        protein1_hierarchy = self.representation.find_by_id(
            'Protein1').model_decorator
        ...
        restraint_set = self.restraint.get_restraint_set_by_name(
            "pulldown_restraint_set")
