...
#ifndef IMPDOMINO2_COMB_STATE_H
#define IMPDOMINO2_COMB_STATE_H
...
/**
   ...
   is_subset queries
**/
class IMPDOMINO2EXPORT CombState
{
 public:
  //! Constructor
  CombState() {
    ...
    for (CombData::const_iterator it = other->data_.begin();
      ...
      if (data_.find(p) == data_.end()) {
        ...
        IMP_INTERNAL_CHECK(data_[p] == it->second,
                           " CombState::combine the state of particle"
                           << " with name :"
