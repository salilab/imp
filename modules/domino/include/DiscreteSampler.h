...
class IMPDOMINOEXPORT DiscreteSampler : public Sampler
{
 ...
 protected:
  IntsLists do_sample_attributes(
...
public:
  ...
  ~DiscreteSampler();
  //! Sample a set of Int attributes for specific particles
  /**
     The function is useful when a large set of assignments is generated by
     only a small fraction of attirbutes is of intrest
   */
  IntsLists get_sample_attributes(
    const std::vector<std::pair<IntKey,Particles> >&list) const;
