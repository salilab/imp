...
class IMPDOMINOEXPORT RestraintCache : public base::Object {
  ...
  class Generator {
   ...
   public:
    ...
    void add_to_set(RestraintSet *rs, Restraint *r, Slice slice, double max) {
  ...
  void add_restraint_set_child_internal(Restraint *r, const Subset &cur_subset,
                                        RestraintSet *parent, double parent_max,
  ...
  */
  void save_cache(const ParticlesTemp &particle_ordering,
                  const RestraintsTemp &restraints, RMF::HDF5::Group group,
