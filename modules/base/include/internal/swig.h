...
IMPBASEEXPORT std::string _test_ifile_overloaded(base::TextInput a,
                                                 std::string st);
...
IMPBASEEXPORT Strings _pass_overloaded_strings(const Strings &a, int);
IMPBASEEXPORT Strings _pass_overloaded_strings(const Strings &a);

IMPBASEEXPORT DerivativePair _pass_pair(const DerivativePair &p);
