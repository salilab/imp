...
IMP::base::Vector<IMP::base::Entry> get_list(
    IMP::base::IP pi, IMP::base::Vector<IMP::base::IP> excluded) {
...
struct SortedPairs {
  struct StarLess {
    bool operator()(IMP::base::IP a, IMP::base::IP b) const { return *a < *b; }
  };
  SortedPairs() {}
...
struct SetEquals {
  struct LessPair {
    bool operator()(IMP::base::Entry a, IMP::base::Entry b) const {
...
struct Sum {
  int value;
  Sum() : value(0) {}
  void operator()(IMP::base::Entry a) { value += *a[0] + *a[1]; }
};
