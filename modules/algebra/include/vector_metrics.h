/**
 *  \file vector_metrics.h   \brief Functions to generate vectors.
 *
...
public:
  ...
  virtual double get_distance(const VectorKD &a,
                              const VectorKD &b) const=0;
...
public:
  ...
  double get_distance(const VectorKD &a,
                      const VectorKD &b) const {
