...
Vector4Ds get_derivatives_of_composed_with_respect_to_first(
    const Rotation3D &q, const Rotation3D &p) {
  return internal::get_derivative_of_composed(q.get_quaternion(), p.get_quaternion(), true);
}

Vector4Ds get_derivatives_of_composed_with_respect_to_second(
    const Rotation3D &q, const Rotation3D &p) {
  return internal::get_derivative_of_composed(q.get_quaternion(), p.get_quaternion(), false);
}
