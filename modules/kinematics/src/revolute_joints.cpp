...
RevoluteJoint::RevoluteJoint(IMP::core::RigidBody parent,
...
void RevoluteJoint::update_child_node_reference_frame() const {
  ...
  Transformation3D tr_child_to_parent_new = R * tr_child_to_parent_old;
  last_updated_angle_ = angle_;
  const_cast<RevoluteJoint*>(this)
      ->set_transformation_child_to_parent_no_checks(tr_child_to_parent_new);
...
double RevoluteJoint::get_angle() const {
  if (get_owner_kf()) {
...
void RevoluteJoint::set_angle(double angle) {
  if (get_owner_kf()) {
    get_owner_kf()->update_all_internal_coordinates();
  }
  angle_ = angle;
...
DihedralAngleRevoluteJoint::DihedralAngleRevoluteJoint(
    IMP::core::RigidBody parent, IMP::core::RigidBody child, IMP::core::XYZ a,
    IMP::core::XYZ b, IMP::core::XYZ c, IMP::core::XYZ d)
    : RevoluteJoint(parent, child),
      a_(a),
      b_(b),
      c_(c),
      d_(d)  // TODO: are b_ and c_ redundant?
{
  update_axis_of_rotation_from_cartesian_witnesses();
  update_joint_from_cartesian_witnesses();  // angle only
}

double DihedralAngleRevoluteJoint::get_current_angle_from_cartesian_witnesses()
    const {
...
BondAngleRevoluteJoint::BondAngleRevoluteJoint(IMP::core::RigidBody parent,
                                               IMP::core::RigidBody child,
                                               IMP::core::XYZ a,
                                               IMP::core::XYZ b,
                                               IMP::core::XYZ c)
    : RevoluteJoint(parent, child), a_(a), b_(b), c_(c) {
  update_axis_of_rotation_from_cartesian_witnesses();
  update_joint_from_cartesian_witnesses();
}

double BondAngleRevoluteJoint::get_current_angle_from_cartesian_witnesses()
    const {
  // TODO: add derivative support?
