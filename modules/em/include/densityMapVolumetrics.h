...
/*! sets the protein density value used for internal computations
 * \param[in] densityValue : the protein density value that is used in internal
...
//! sets the protein density value used for internal computations
/*! sets the protein density value used for internal computations
 * \param[in] densityReference : a reference protein density value that
 ...
 * \param[in] densityReference : the name of a reference
 *   (See ProteinDensityReference for authorized values)
 *
