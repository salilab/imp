...
class Tests(IMP.test.TestCase):
    ...
    def test_map_padding(self):
        ...
        self.assertEqual(
            min1,
            self.d1.get_min_value(),
            "wrong map values after padding")
        self.assertEqual(
            min2,
            self.d2.get_min_value(),
            "wrong map values after padding")
        self.assertEqual(
            max1,
            self.d1.get_max_value(),
            "wrong map values after padding")
        self.assertEqual(
            max2,
            self.d2.get_max_value(),
            "wrong map values after padding")
