...
class KernelParametersTest(IMP.test.TestCase):
    ...
    def test_for_resolution_of_10(self):
        self.assertInTolerance(self.kp.get_rsig(),4.24660921,0.001)
    ...
    def test_for_resolution_of_10_and_radius_of_1(self):
        ...
        print dir(kp)
        print type(kp)
        self.assertInTolerance(kp.get_vsig(),1./math.sqrt(2)*rad,0.001)
        self.assertInTolerance(kp.get_vsig()*kp.get_vsig(),
                             kp.get_vsigsq(),0.001)
