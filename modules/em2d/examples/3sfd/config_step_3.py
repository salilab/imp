...
# <============== This has changed to make the running time short
...
class DominoSamplingPositions:
    ...
    def __init__(self):
        ...
        self.max_number = 5  # max number of solutions to combine
...
class Experiment (object):
    ...
    def __init__(self,):
        ...
        # Cross-linking restraints component1,residue1, component2, residue2,
