...
class Vector4DTests(IMP.test.TestCase):
    def test_magnitude(self):
        ...
        v = IMP.Vector4D(1.0, 2.0, 3.0, 4.0)
    ...
    def test_scalar_product(self):
        ...
        v1 = IMP.Vector4D(1.0, 2.0, 3.0, 4.0)
        v2 = IMP.Vector4D(10.0, 1.0, 2.0, 3.0)
    ...
    def test_difference(self):
        ...
        diff = v1 - v2
        v1 -= v2
        expected_diff = IMP.Vector4D(-9.0, 1.0, 1.0, 1.0)
    ...
    def test_addition(self):
        ...
        expected_sum = IMP.Vector4D(11.0, 3.0, 5.0, 7.0)
    ...
    def test_scalar_division(self):
        ...
        v1 = IMP.Vector4D(3.0, 6.0, 9.0, 27.0)
        idv1 = id(v1)
        s1 = 3.0
        prod = v1 / s1
        v1 /= s1
    ...
    def test_distance(self):
        ...
        v1 = IMP.Vector4D(3.0, 6.0, 9.0, 0.0)
        v2 = IMP.Vector4D(1.0, 2.0, 3.0, 10.0)
        self.assertRaises(TypeError, IMP.squared_distance, v1, v2)
