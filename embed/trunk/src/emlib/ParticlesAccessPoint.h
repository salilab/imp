...
public:
  ...
  virtual float get_x(int index)const {return 0.0;}
  virtual float get_y(int index)const {return 0.0;}
  virtual float get_z(int index)const {return 0.0;}
  virtual float get_r(int index)const {return 0.0;} 
  virtual float get_w(int index)const {return 0.0;}
