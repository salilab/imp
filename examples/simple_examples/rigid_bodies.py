...
IMP.core.create_rigid_bodies(rbs, IMP.core.LeavesRefiner(IMP.atom.Hierarchy.get_traits()))
...
rbd=IMP.core.create_rigid_body(chains[0], IMP.atom.get_by_type(mp1, IMP.atom.Hierarchy.ATOM))
print "all done"
