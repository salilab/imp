...
Restraints CoreGroupnamesRestraint::get_decomposition() const {
    Restraints ret(pc_->get_number());
    for (unsigned int i=0; i< ret.size(); ++i) {
      ret[i]= new GroupnameRestraint(ss_, pc_->get(i));
    }
    return ret;
  }

void CoreGroupnamesRestraint::do_show(std::ostream& out) const
{
