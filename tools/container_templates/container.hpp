...
typedef std::pair<GroupnameContainer*,
                  GroupnameContainer*> GroupnameContainerPair;
...
class IMPEXPORT GroupnameContainer : public Container
{
  ...
  */
  virtual GroupnameContainerPair
...
public:
  ...
  /** \name Incremental Scoring
      ...
      @{
  */
  GroupnameContainer* get_removed_container() const {
    // must not be an added or removed container
    get_model();
    if (!added_) {
      std::pair<GroupnameContainer*, GroupnameContainer*>
  ...
  GroupnameContainer* get_added_container() const {
    // must not be an added or removed container
    if (!added_) {
      std::pair<GroupnameContainer*, GroupnameContainer*>
        cp= get_added_and_removed_containers();
  ...
  */
  ...
  virtual const ClassnamesTemp& get_access() const {
