...
ContainersTemp GroupnamesConstraint::get_input_containers() const {
  return ContainersTemp(1, c_);
}

ContainersTemp GroupnamesConstraint::get_output_containers() const {
...
void GroupnamesConstraint::do_show(std::ostream &out) const {
  out << "on " << *c_ << std::endl;
