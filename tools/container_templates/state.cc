...
CLASSNAMEsConstraint::CLASSNAMEsConstraint(CLASSNAMEContainer *c,
                                           CLASSNAMEModifier *before,
...
ScoreStates CLASSNAMEsConstraint::get_instant_decomposition() const {
