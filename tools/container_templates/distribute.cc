/**
 *  \file CLASSNAMEsPredicateRestraint.cpp   \brief Container for LCCLASSNAME.
 *
...
#include "IMP/container/CLASSNAMEsPredicateRestraint.h"

IMPCONTAINER_BEGIN_NAMESPACE

CLASSNAMEsPredicateRestraint
...
void CLASSNAMEsPredicateRestraint::do_show(std::ostream &) const {
}
