...
Section ""
  ...
  WriteRegStr HKLM "Software\Python\PythonCore\3.14${PYTHON_ARCH_SUFFIX}\PythonPath\${PRODVER}" "" "$INSTDIR\python"
...
!endif
  ...
  DeleteRegKey HKLM "Software\Python\PythonCore\3.14${PYTHON_ARCH_SUFFIX}\PythonPath\${PRODVER}"
