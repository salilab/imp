...
tools that use %IMP:
 ...
 - [Small-Angle X-Ray Profile](https://www.cgl.ucsf.edu/chimera/docs/ContributedSoftware/saxs/saxs.html): calculate a theoretical small-angle X-ray scattering (SAXS) profile from a set of atoms
