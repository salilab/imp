...
m = IMP.Model()
mp0= IMP.modeller.read_pdb('doc/examples/simple_examples/single_protein.pdb', m)
...
# load another copy
mp1= IMP.modeller.read_pdb('doc/examples/simple_examples/single_protein.pdb', m)
