...
class test_pair_connectivity(IMP.test.IMPTestCase):
    ...
    def test_connectivity(self):
        ...
        score_func_params = IMP.BasicScoreFuncParams("harmonic_lower_bound", 0.0, 0.1)
        rsrs.append(IMP.ExclusionVolumeRestraint(self.imp_model, particle_indexes1, particle_indexes2, "radius", score_func_params))
