...
IMPMEMBRANEEXPORT IMP::Pointer<core::DistancePairScore> get_pair_score(
    FloatRange dist, double kappa);

IMPMEMBRANEEXPORT IMP::Pointer<core::SphereDistancePairScore>
get_sphere_pair_score(FloatRange dist, double kappa);

IMPMEMBRANEEXPORT IMP::Pointer<core::SphereDistancePairScore>
get_sphere_pair_score(double dist, double kappa);

IMPMEMBRANEEXPORT void add_SPBexcluded_volume(Model *m, RestraintSet *allrs,
                                              atom::Hierarchies &hs,
                                              bool GFP_exc_volume,
                                              double kappa);
...
IMPMEMBRANEEXPORT void add_my_connectivity(Model *m, RestraintSet *allrs,
                                           std::string name,
                                           atom::Molecule protein,
                                           double kappa);

IMPMEMBRANEEXPORT void add_restrain_protein_length(
    Model *m, RestraintSet *allrs, const atom::Hierarchy &hs,
    std::string protein_a, Particle *dist, double sigma0_dist);

IMPMEMBRANEEXPORT void add_restrain_coiledcoil_to_cterm(
    Model *m, RestraintSet *allrs, const atom::Hierarchy &hs,
    std::string protein_a, Particle *dist, double sigma0_dist);
...
IMPMEMBRANEEXPORT void add_layer_restraint(
...
IMPMEMBRANEEXPORT IMP::Pointer<container::MinimumPairRestraint> y2h_restraint(
...
IMPMEMBRANEEXPORT void add_tilt_restraint(Model *m, RestraintSet *allrs,
...
IMPMEMBRANEEXPORT void add_GFP_restraint(Model *m, RestraintSet *allrs,
                                         const atom::Hierarchy &h,
                                         double kappa);

IMPMEMBRANEEXPORT void add_stay_close_restraint(Model *m, RestraintSet *allrs,
                                                const atom::Hierarchy &h,
                                                std::string protein,
                                                double kappa);
...
IMPMEMBRANEEXPORT void add_diameter_rgyr_restraint(
