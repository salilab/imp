...
included_methods={"kernel":{"base::set_check_level":("void", "(CheckLevel)"),
                            "base::set_log_level":("void", "(LogLevel)"),
                  ...
                  "rmf":{"add_hierarchy":("void", "(RMF::FileHandle, atom::Hierarchy)"),
                         "save_frame":("void", "(RMF::FileHandle, unsigned int, atom::Hierarchy)"),
                         "load_frame":("void", "(RMF::FileConstHandle, unsigned int, atom::Hierarchy)"),
                         "create_hierarchies":("atom::Hierarchies", "(RMF::FileConstHandle, Model*)"),
                         "set_hierarchies":("void", "(RMF::FileConstHandle, atom::Hierarchies, bool)"),
                         "add_geometry":("void", "(RMF::FileHandle, display::Geometry*)"),
                         "save_frame":("void", "(RMF::FileHandle, int, display::Geometry*)"),
                         "create_geometries":("display::Geometries", "(RMF::FileConstHandle, int)"),
